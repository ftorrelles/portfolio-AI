...
// Nex-Dark styled device/browser-chrome panel. Renders the real screenshot
// when the asset exists; falls back to a dashed placeholder (no broken-image
// icon) when it doesn't — real screenshots may not be exported yet.
export default function DeviceFrame({ slug, screenSlug, image, label }: Props) {
